...
function EmeyinTehlukesizliyiDetail() {
  return (
    <>
      <FealiyyetimizContainer 
        pageTitle={"ƏMƏYİN TƏHLÜKƏSİZLİYİ"}
        ...
        xeberTitle={"Tələbələr arasında keçirilmiş müsabiqə-festivalın yekun konserti olub"}
...
export default EmeyinTehlukesizliyiDetail
